...
Geometrisch gesprochen entspricht das Punktprodukt dem Ausmaß, in dem zwei Vektoren in die gleiche Richtung zeigen, vgl. @fig-dot2, [Quelle: Martin Thoma, Wikipedia, CC-BY 3.0](https://commons.wikimedia.org/wiki/User:MartinThoma).
...
### Multiple Regression als Matrixmultiplikation

Die multiple Regression kann man als Matrixmultiplikation auffassen.
...
Speichern wir uns die Modellkoeffizienten, $\beta_0, \beta_1$ in einem Objekt $\matr{\beta}}$ ab:
