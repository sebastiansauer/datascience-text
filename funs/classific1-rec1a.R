...
rec1a_prepped <- read_rds("/Users/sebastiansaueruser/github-repos/datascience-text/objects/rec1a_prepped.rds")
...
ds_rec1a_baken_part1 <- bake(rec1_prepped, ds %>% slice(1:5e5))

write_rds(ds_rec1a_baken_part1, file = "/Users/sebastiansaueruser/datasets/Twitter/hate-classific/ds_rec1a_baken_part1.rds")


ds_rec1a_baken_part2 <- bake(rec1_prepped, ds %>% slice(5e5+1:n()))
write_rds(ds_rec1a_baken_part2, file = "/Users/sebastiansaueruser/datasets/Twitter/hate-classific/ds_rec1a_baken_part2.rds")
